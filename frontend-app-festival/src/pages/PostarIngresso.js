...
function PostarIngresso() {
  ...
  const postIngresso = data =>
    Axios.post("http://localhost:3344/ingresso", data)
      .then(() => {
        navigate("/");
      })
      .catch(() => {
        ...
        <div className={styles.blackOverlay}>
          <div className={styles.Container}>
            ...
            >
              ...
              <button className={styles.submit}>Adicionar ingresso</button>
            </form>
